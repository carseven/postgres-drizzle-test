...
//     debugTree() {
//         return require('object-treeify')(debugNode(this._root)).replace(/^.{3}/gm, ''); // Remove the first 3 characters of every line
//     }
// }
...
//         childRoutes[label] =
//             parametricChild.staticChild === null ? null : debugNode(parametricChild.staticChild);
//     }
